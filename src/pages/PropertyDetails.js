    ...
    <div className='container mx-auto min-h-[800px] mb-14'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='mb-4 lg:mb-0 flex gap-x-2 text-sm'>
          <div className='bg-pink-500 rounded-full text-white px-3 inline-block'>
            {property.type}
          </div>
      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        <div className='max-w-[768px]'>
          ...
          <div className='flex gap-x-6 text-blue-600 mb-6'>
        ...
        <div className='flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8'>
          <div className='flex items-center gap-x-4 mb-8'>
            ...
            <div>
              <div className='font-bold text-blue-700 text-lg'>{property.agent.name}</div>
          ...
          <form className='flex flex-col gap-y-4'>
            ...
            <div className='flex gap-x-2'>
              <button
                className='bg-blue-700 hover:bg-pink-600 text-white rounded p-4 text-sm w-full transition'
                type='submit'
              >
                Send message
              </button>
              <button className='border border-violet-700 text-violet-700 hover:border-purple-600 hover:text-pink-600 rounded p-4 text-sm w-full transition'>
                Call
              </button>
            </div>
          </form>
